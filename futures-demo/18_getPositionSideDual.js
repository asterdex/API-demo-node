/**
 * Get Current Position Mode / 查询持仓模式
...
async function getPositionSideDual() {
    try {
        ...
        const response = await axios.get(`${config.BASE_URL}/fapi/v1/positionSide/dual?${queryString}`, {
            headers: {
...
module.exports = getPositionSideDual;
